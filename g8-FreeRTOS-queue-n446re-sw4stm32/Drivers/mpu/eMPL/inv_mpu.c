...
#define log_i		mpu_log_i
#define log_e		mpu_log_e
/* labs is already defined by ARM toolchain. */
/* fabsf is already defined by ARM toolchain. */
...
#error  Which chip are you using? Define MPUxxxx in MPU.h
#endif
...
const struct test_s test = {
    ...
    .accel_sens     = 32768/16,  //FSR = +-2G = 16384 LSB/G
    .reg_rate_div   = 0,    /* 1kHz. */
